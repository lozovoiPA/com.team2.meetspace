...
Для запуска приложения необходимо установить и синхронизовать зависимости Gradle, для этого необходимо выбрать в меню File команду Sync Project With Gradle Files.
